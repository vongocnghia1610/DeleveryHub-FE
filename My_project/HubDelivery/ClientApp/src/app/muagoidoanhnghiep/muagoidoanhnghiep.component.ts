...
// return this.array[1];
this.http.get(`http://54.255.93.14/enterprises/show-goidoanhnghiep`).subscribe(data=>
{

  console.log(data)
 this.a=Object.entries(data)
 
 
 this.a=Object.values(this.a[0][1])
 console.log(this.a)
 

 

  this.a= this.a.find(x => x.TenGoi ==this.array[1] );
  console.log(this.a)
  this.a=Object.entries(this.a)
  console.log(this.a)
  return this.a
